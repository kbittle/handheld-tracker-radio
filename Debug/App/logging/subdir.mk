...
OBJS += \
./App/logging/logging.o 

C_DEPS += \
./App/logging/logging.d 


# Each subdirectory must supply rules for building sources it contributes
App/logging/%.o App/logging/%.su App/logging/%.cyclo: ../App/logging/%.c App/logging/subdir.mk
...
clean: clean-App-2f-logging

clean-App-2f-logging:
	-$(RM) ./App/logging/logging.cyclo ./App/logging/logging.d ./App/logging/logging.o ./App/logging/logging.su

.PHONY: clean-App-2f-logging
