...
/* Definitions for gnssDataLock */
osMutexId_t gnssDataLockHandle;
const osMutexAttr_t gnssDataLock_attributes = {
  .name = "gnssDataLock"
};
/* Definitions for uiDataLock */
osMutexId_t uiDataLockHandle;
const osMutexAttr_t uiDataLock_attributes = {
  .name = "uiDataLock"
};
/* Definitions for debugLock */
osMutexId_t debugLockHandle;
const osMutexAttr_t debugLock_attributes = {
  .name = "debugLock"
};
/* Definitions for sdCardAccessLock */
osMutexId_t sdCardAccessLockHandle;
const osMutexAttr_t sdCardAccessLock_attributes = {
  .name = "sdCardAccessLock"
};
/* USER CODE BEGIN PV */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, USER_LED3_Pin|USER_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, TFT_RST_Pin|TFT_BL_CTRL_Pin|TFT_CS_Pin|LD2_Pin
                          |RADIO_PWR_CTRL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GNSS_PWR_CTRL_Pin|GNSS_BKUP_PWR_CTRL_Pin|GNSS_ON_OFF_Pin|TFT_DC_Pin
                          |USER_LED2_Pin|SAI_MUTE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USER_LED3_Pin USER_LED_Pin */
  GPIO_InitStruct.Pin = USER_LED3_Pin|USER_LED_Pin;
  ...
  /*Configure GPIO pins : TFT_RST_Pin TFT_BL_CTRL_Pin TFT_CS_Pin LD2_Pin
                           RADIO_PWR_CTRL_Pin */
  GPIO_InitStruct.Pin = TFT_RST_Pin|TFT_BL_CTRL_Pin|TFT_CS_Pin|LD2_Pin
                          |RADIO_PWR_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : GNSS_PWR_CTRL_Pin GNSS_BKUP_PWR_CTRL_Pin GNSS_ON_OFF_Pin TFT_DC_Pin
                           USER_LED2_Pin SAI_MUTE_Pin */
  GPIO_InitStruct.Pin = GNSS_PWR_CTRL_Pin|GNSS_BKUP_PWR_CTRL_Pin|GNSS_ON_OFF_Pin|TFT_DC_Pin
                          |USER_LED2_Pin|SAI_MUTE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
